...
Follow instruction to build bitcoin: [alevchuk/minibank/bitcoin](https://github.com/alevchuk/minibank/tree/first/bitcoin/README-with-chroot.md)
...
Follow instrutions under [alevchuk/minibank/lightning](https://github.com/alevchuk/minibank/tree/first/lightning/README-with-chroot.md)
...
To install and run Grafana follow [alevchuk/minibank/grafana](https://github.com/alevchuk/minibank/blob/first/grafana/README-with-chroot.md)
